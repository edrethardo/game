...
def build_meshes():
    ...
    meshes = [
        ...
        ["--type", "cave_mouth", "--height", "3.4", "--out", os.path.join(mesh_dir, "cave_mouth.obj")],
        ["--type", "stone_circle", "--height", "3.2", "--out", os.path.join(mesh_dir, "stone_circle.obj")],
        ["--type", "cairn_stone", "--height", "2.4", "--out", os.path.join(mesh_dir, "cairn_stone.obj")],
        ["--type", "hell_gate", "--height", "4.4", "--out", os.path.join(mesh_dir, "hell_gate.obj")],
        ["--type", "grave_gate", "--height", "3.0", "--out", os.path.join(mesh_dir, "grave_gate.obj")],
        ["--type", "tube_entrance", "--height", "3.2", "--out", os.path.join(mesh_dir, "tube_entrance.obj")],
        ["--type", "service_door", "--height", "2.8", "--out", os.path.join(mesh_dir, "service_door.obj")],
...
def build_skins():
    ...
    skins = [
        ...
        ("cave_mouth",              "cave_mouth_skin_42.png"),
        ("stone_circle",            "stone_circle_skin_42.png"),
        ("cairn_stone",             "cairn_stone_skin_42.png"),
        ("hell_gate",               "hell_gate_skin_42.png"),
        ("grave_gate",              "grave_gate_skin_42.png"),
        ("tube_entrance",           "tube_entrance_skin_42.png"),
        ("service_door",            "service_door_skin_42.png"),
