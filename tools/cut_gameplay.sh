#!/usr/bin/env bash
# cut_gameplay.sh — the GAMEPLAY trailer's edit list (WB-273, epic WB-267). v8.
#
...
clip gw_revolver  5.0 2.2
clip gw_launcher  9.5 2.2
...
finish "$TAKES/trailer_gameplay_v8.mp4"
