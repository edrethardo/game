...
clip g_orb        TRIM_ORB 4.0
clip g_lava       TRIM_LAVA 3.5
clip g_vhall      TRIM_VHALL 3.5
pngcard "$ST/card_9_classes.png" 1.3
clip g_tinkerer   TRIM_TINK 3.5
clip g_engineer   TRIM_ENG 3.5
clip g_descent    TRIM_DESC 3.5
pngcard "$ST/card_dungeon_engine.png" 1.3
clip g_boss       TRIM_BOSS 6.0
clip g_chakram    TRIM_CHAK 4.5
pngcard "$ST/card_couch.png" 1.3
clip g_couch      TRIM_COUCH 3.5
clip g_death      TRIM_DEATH 1.5
