...
#include "renderer/item_icons_gen.h"  // tool-generated ITEM_ICON_*_ROWS (tools/gen_item_icons.py)
#include "game/item.h"
...
static const u16 s_iconData[][16] = {
    ...
    // 14: HELMET — dome/great-helm shape
    {
    ...
    // 15: ARMOR — breastplate/chest silhouette
    {
    ...
    // 16: BOOTS — side-profile boot shape
    {
    ...
    // 18: (unused padding — keeps atlas row alignment; atlas is 16 cols × 2 rows)
    {
        0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000,
        0x0000, 0x0000, 0x0000, 0x0000,
    ...
    // 19: CLAYMORE — tall two-handed greatsword (narrow blade, long, big crossguard + pommel)
    {
        0x0100, // .......#.......  tip
        0x0380, // ......###......  blade
        0x0380, // ......###......  blade
    ...
    // 20: CLEAVER — wide heavy blade on short handle (butcher knife)
    {
        0x0000, // ................
    ...
    // 21: GLOVES — open-hand silhouette, generated by tools/gen_item_icons.py (do not hand-edit;
    // change draw_gloves() in that tool and rerun build_assets.py so CI rebuilds it).
    // NOTE: slotToIconIndex(GLOVES) MUST return 21 to match this position.
    { ITEM_ICON_GLOVES_ROWS },
    // 22: CHAKRAM — bladed throwing ring, generated by tools/gen_item_icons.py (draw_chakram).
    // NOTE: subtypeToIconIndex(CHAKRAM) MUST return 22 to match this position.
    { ITEM_ICON_CHAKRAM_ROWS },
};
...
static u32 subtypeToIconIndex(WeaponSubtype st) {
    switch (st) {
        ...
        case WeaponSubtype::CHAKRAM:        return 22;  // bladed throwing ring (s_iconData[22])
        default:                            return 0;
    }
}
...
static u32 slotToIconIndex(ItemSlot slot) {
    switch (slot) {
        ...
        case ItemSlot::GLOVES:  return 21;  // s_iconData[21] (the generated ITEM_ICON_GLOVES_ROWS
                                            // entry) — 20 is the CLEAVER blade, which is why gloves
                                            // were rendering as the cleaver.
        default:                return 0;
    }
}
